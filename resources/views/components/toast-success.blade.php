@props(['on' => 'success', 'message' => 'Success'])
...
<div x-data="{ shown: false, timeout: null }" x-init="@this.on('{{ $on }}', () => {
  ...
  role="alert">
  <div
    class="flex items-center px-4 py-3 mb-4 text-green-600 bg-white border border-gray-300 shadow-2xl md:ml-64 min-w-72 dark:border-gray-600 rounded-xl dark:bg-gray-800 dark:text-green-400"
    role="alert">
    <span class="p-1 mr-3 bg-green-200 rounded-full dark:bg-green-800">
